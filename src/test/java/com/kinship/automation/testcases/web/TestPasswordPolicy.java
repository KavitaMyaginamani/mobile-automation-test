...
/**
 * @author priya.mishra01 @Date 21-06-2022
 */
public class TestPasswordPolicy extends WebBaseTest {

  // Added by Ganesh
  @TestRails(id = "C1014107")
  ...
  public void testPetParentPasswordPolicy() throws Exception {
    ...
    goodFriendHomePage.checkPasswordPolicy(
        FrameworkConfigFactory.getConfig().currentpassword(),
        FrameworkConfigFactory.getConfig().newpasswordpolicy());
    Thread.sleep(20000);
  }
}
