 ...
 */
public class TestCookiesPolicyFooter extends WebBaseTest {
  ...
  public void testCookiesLogoFooter() {
    log.info(" Starting test case to click and open Cookies Page");
    goodFriendHomePage =
        goodFriendBasePage.navigateToGoodFriendHomePage(FrameworkConfigFactory.getConfig().url());
    goodFriendHomePage.clickOnCookiesLogo();
