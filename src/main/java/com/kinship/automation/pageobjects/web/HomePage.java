...
public class HomePage extends WildestBasePage {
  ...
  private By profiileIconButton =
      ByT.locator(By.xpath("//*[text()='The Wildest Profile Icon’]//ancestor::button"));
  ...
  private By footerSecondaryNavigation =
      ByT.locator(By.xpath("//footer//ul[@aria-label=\"secondary navigation”]"));
  ...
  private By invalidCredErrorMessage =
      ByT.locator(By.xpath("//div//span[text()=\"Login or password is incorrect\"]"));
  ...
  public HomePage invalidPassword() throws InterruptedException {
    ...
    driver
        ...
        .sendKeys(Utils.getValuesFromPropertiesFile("global", "InvalidPasswordWildest"));
    driver.clickLocator(loginButton);
    return this;
  }
  ...
  public HomePage invalidEmailAddress() throws InterruptedException {
    ...
    driver
        ...
        .sendKeys(Utils.getValuesFromPropertiesFile("global", "invalidEmail"));
    return this;
  }
