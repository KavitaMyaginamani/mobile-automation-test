...
public class TestRail {
  ...
  public void testRail(int Status, String testCaseID, String runId, String errorMsg)
    ...
    if (!runId.isEmpty()) {
      JSONObject r =
          (JSONObject) client.sendPost("add_result_for_case/" + runId + "/" + testCaseID, data);
    }
  }

  @Step("Get failed Test Cases")
  public static List<String> getFailedTCs(String runId)
      throws MalformedURLException, IOException, APIException {
    try {
      Map<String, Comparable> data = new HashMap<String, Comparable>();
  ...
  public static void createTestRunSuiteId(ITestContext testContext)
  ...
  public static String getTestCaseId(Method method, final ITestContext testContext)
  ...
  public static void addResultsInTestRail(int status, String errorMessage, ITestContext testContext)
      throws Exception {
    if (FrameworkConfigFactory.getConfig().updateTestRailFlag().equalsIgnoreCase("true")) {
      Map<String, Object> data = new HashMap<String, Object>();

      if (status == 5) data.put("comment", errorMessage);
  ...
  public static void addResultsInTestRail(HashMap<String, String> testCaseIds) throws Exception {
    if (FrameworkConfigFactory.getConfig().updateTestRailFlag().equalsIgnoreCase("true")) {
      ...
      Map<String, Object> data = new HashMap<String, Object>();
      String runid =
          FrameworkConfigFactory.getConfig().createNewTestRun().equalsIgnoreCase("true")
              ? String.valueOf(Constants.NEW_RUN_ID)
              : String.valueOf(FrameworkConfigFactory.getConfig().existingRunID());
