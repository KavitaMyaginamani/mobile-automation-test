  ...
  public void onTestStart(ITestResult result) {
    ...
    String sTestName =
        result.getMethod().getMethodName()
            + " ("
            + FrameworkConfigFactory.getConfig().platform()
            + ")";

    if ((FrameworkConfigFactory.getConfig().remoteType().toString().contains("browserstack"))) {
      // if( (DriverFactory.platfrom.equals("bs-android")) ||
      // (DriverFactory.platfrom.equals("bs-ios")) ) {
