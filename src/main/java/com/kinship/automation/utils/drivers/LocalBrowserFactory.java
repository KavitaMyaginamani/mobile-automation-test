...
public final class LocalBrowserFactory {
  ...
  private static final Map<WebDriverType, Supplier<WebDriver>> driverMap =
      new EnumMap<>(WebDriverType.class);
  ...
  public static final WebDriver getDriver() {
    ...
    return driverMap
        .getOrDefault(FrameworkConfigFactory.getConfig().browser(), chromeDriverSupplier)
        .get();
  }
}
